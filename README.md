# 1. 创建 controller  user
  a. nest g co user
# 2. CRUD 生成器
  a. nest g resource [name]
  b. nest g res user 简写
# 3. 创建一个中间件 logger
  a.  Nest g mi middleWare/Logger
  b. CREATE src/middle-ware/logger.middleware.ts
# 4. 创建管道 
  a. nest g pi pipe/parseInt
  b. CREATE src/pipe/parse-int.pipe.ts 
# 5.创建模块 module 
  nest g mo jwtDemo
# 新建服务 service
  nest g s jwtDemo
...
- [x] Docker 部署环境
- [x] Swagger 构建 API 文档 yarn add @nestjs/swagger swagger-ui-express -D 
      localhost:8000/doc
- [x] WebSocket 实现数据传输
